<template>
  <div>
    ...
    <input v-model="tituloTarefa" placeholder="Digite o Título da Tarefa">
    <textarea v-model="descricaoTarefa" placeholder="Digite a Descrição da Tarefa"></textarea>
...
<script setup>
  ...
  const API_URL = "https://localhost:5081/api/tarefas";
